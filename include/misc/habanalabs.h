 ...
 */
#define HL_CS_FLAGS_ENCAP_SIGNALS		0x400
#define HL_CS_FLAGS_RESERVE_SIGNALS_ONLY	0x800
#define HL_CS_FLAGS_UNRESERVE_SIGNALS_ONLY	0x1000
...
struct hl_cs_out {
	union {
		/*
		 * seq holds the sequence number of the CS to pass
		 * to wait ioctl. All values are valid except
		 * for 0 and ULLONG_MAX
		 */
		__u64 seq;
