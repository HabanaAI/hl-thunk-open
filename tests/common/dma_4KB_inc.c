...
{
	int num_tests = sizeof(dma_4KB_inc_tests) /
			sizeof((dma_4KB_inc_tests)[0]);

	hltests_parser(argc, argv, usage, HLTHUNK_DEVICE_INVALID,
			dma_4KB_inc_tests, num_tests);

	return hltests_run_group_tests("dma_4KB_inc", dma_4KB_inc_tests,
