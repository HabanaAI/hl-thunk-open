...
{
	int num_tests = sizeof(dma_1KB_inc_tests) /
			sizeof((dma_1KB_inc_tests)[0]);

	hltests_parser(argc, argv, usage, HLTHUNK_DEVICE_INVALID,
			dma_1KB_inc_tests, num_tests);

	return hltests_run_group_tests("dma_1KB_inc", dma_1KB_inc_tests,
